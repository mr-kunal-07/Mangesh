  ...
  mr: {
    translation: {
      ...
      collections: {
        ...
        shareReceiptTitle: 'पावती शेअर करा', shareReceiptCopy: '{{name}} यांची पावती {{number}} तयार आहे.', shareWhatsApp: 'WhatsApp वर पावती शेअर करा', sharePreparing: 'पावती तयार होत आहे…', shareComplete: 'पावती शेअर झाली.', shareFallback: 'पावतीचा मजकूर WhatsApp मध्ये तयार आहे. पाठवण्यासाठी Send दाबा.', dismiss: 'नंतर',
      ...
      memberLedger: {
        ...
        paymentHistory: 'पेमेंट आणि पावती इतिहास', paymentHistoryCopy: 'या आर्थिक वर्षातील सर्व वर्गणी पेमेंट', noPayments: 'या सभासदाचे पेमेंट उपलब्ध नाही.', view: 'पहा', share: 'शेअर करा', preparing: 'तयार होत आहे…', shareComplete: 'पावती शेअर झाली.', shareFallback: 'पावतीचा मजकूर WhatsApp मध्ये तयार आहे. पाठवण्यासाठी Send दाबा.',
      ...
      export: {
        ...
        invalidRange: 'योग्य पावती क्रमांकाची रेंज निवडा.', downloadSuccess: 'Excel यशस्वीरित्या डाउनलोड झाला.', downloadError: 'Excel फाइल तयार करता आली नाही. कृपया पुन्हा प्रयत्न करा.',
      },
      status: {
  ...
  en: {
    translation: {
      ...
      collections: {
        ...
        shareReceiptTitle: 'Share receipt', shareReceiptCopy: 'Receipt {{number}} for {{name}} is ready.', shareWhatsApp: 'Share receipt on WhatsApp', sharePreparing: 'Preparing receipt…', shareComplete: 'The receipt was shared.', shareFallback: 'The receipt message is ready in WhatsApp. Press Send to share it.', dismiss: 'Later',
      ...
      export: {
        ...
        downloadSuccess: 'Excel downloaded successfully.', downloadError: 'The Excel file could not be created. Please try again.',
      },
      status: {
