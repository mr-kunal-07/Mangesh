...
const resources = {
  mr: {
    translation: {
      ...
      datePicker: { selectDate: 'दिनांक निवडा', previousMonth: 'मागील महिना', nextMonth: 'पुढील महिना', today: 'आज' },
      header: {
      ...
      expense: {
        kicker: 'व्यवहार', title: 'खर्च व्यवस्थापन', subtitle: 'मंडळाचे खर्च नोंदवा आणि तपासा', add: 'नवीन खर्च', addCopy: 'खर्चाची संपूर्ण माहिती भरा',
        ...
        voucherTitle: 'खर्च पावती', voucherNumber: 'व्हाउचर क्रमांक', previewDraft: 'मसुदा', downloadPdf: 'खर्च PDF डाउनलोड करा', downloadingPdf: 'PDF तयार होत आहे…',
      ...
      reports: {
        ...
        receiptRegisterCopy: 'पावती क्रमांकाच्या रेंजनुसार Excel अहवाल तयार करा.', includes: 'नाव, मोबाईल, पेमेंट, रक्कम आणि एकूण', chooseRange: 'रेंज निवडा',
        ...
        csvTitle: 'संपूर्ण व्यवहार CSV', csvCopy: 'पावत्या आणि खर्च एकाच फाइलमध्ये डाउनलोड करा.', downloadCsv: 'CSV डाउनलोड',
      },
      settings: {
  ...
  en: {
    translation: {
      ...
      datePicker: { selectDate: 'Select date', previousMonth: 'Previous month', nextMonth: 'Next month', today: 'Today' },
      header: {
      ...
      expense: {
        kicker: 'Transactions', title: 'Expense management', subtitle: 'Record and review Mandal expenses', add: 'New expense', addCopy: 'Enter the complete expense information',
        ...
        voucherTitle: 'EXPENSE VOUCHER', voucherNumber: 'Voucher No.', previewDraft: 'DRAFT', downloadPdf: 'Download expense PDF', downloadingPdf: 'Preparing PDF…',
      ...
      reports: {
        ...
        receiptRegisterCopy: 'Create an Excel report for a selected receipt-number range.', includes: 'Includes name, mobile, payment, amount, and totals', chooseRange: 'Choose range',
        ...
        csvTitle: 'Complete transactions CSV', csvCopy: 'Download receipts and expenses together in one file.', downloadCsv: 'Download CSV',
      },
      settings: {
